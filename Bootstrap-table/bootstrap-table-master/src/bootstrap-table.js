...
//          zhaoshuxue
            html.push(
                ...
                // '<li class=""><span>跳转到:</span></li>',
                // '<li class=""><input type="text" value="' + this.options.pageNumber + '"></li>',
                // '<li class="page-go"><a class="pagination-a" href="">GO</a></li>',
                // '</ul>',
                '</div>');
        }
...
//  zhaoshuxue
    BootstrapTable.prototype.onPageGo2 = function (event) {
        ...
        this.options.pageNumber = 3; // +$(event.currentTarget).text();
